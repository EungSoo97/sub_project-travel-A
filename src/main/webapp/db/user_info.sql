...
-- INSERT 시 사용 예시
INSERT INTO user_info (u_user_id, u_login_id, u_password, u_name, u_gender, u_birth_date, u_email)
VALUES (user_info_seq.NEXTVAL, 'test123', 'hash값', '홍길동', 'M', DATE '1990-01-01', 'test@test.com');
...
ALTER TABLE user_info
    ADD u_profile_img VARCHAR2(300);
UPDATE user_info
