...
<html>
  ...
  <body>
    <main>
      <section class="hm-hero">
        ...
        <p class="hm-hero__text">
          출발지, 여행지, 인원, 예산, 여행 스타일을 입력하면 AI가 맞춤 여행
          일정과 추천 경로를 만들어드려요.
        </p>
        <div class="hm-hero__btns">
          ...
          <button
            class="hm-hero__btn hm-hero__btn--sub"
            onclick="
              location.href = '${pageContext.request.contextPath}/explore'
            "
          >
            다른 플랜 둘러보기
          </button>
        ...
        <section class="search section search-section" id="searchContainer">
          <div class="container">
            ...
            <div class="form-grid">
              <div class="form-field form-field--wide">
                ...
                <button
                  ...
                  id="airportTrigger"
                >
                  <span class="airport-trigger__icon"
                    ><i class="fa-solid fa-plane"></i
                  ></span>
                  <span class="airport-trigger__main">
                    <span class="airport-trigger__label">국내 출발 공항</span>
                    <span
                      class="airport-trigger__value"
                      id="airportTriggerValue"
                      >공항을 선택해 주세요</span
                    >
                  </span>
                  <span
                    class="airport-trigger__code"
                    id="airportTriggerCode"
                  ></span>
                </button>
                <input
                  type="hidden"
                ...
                <input
                  type="hidden"
                  id="departureAirportAddress"
                  name="departureAirportAddress"
                />
                <input
                  type="hidden"
                  id="departureAirportRoutes"
                  name="departureAirportRoutes"
                />
              </div>
              ...
              <div class="form-field form-field--wide">
                ...
                >
                  ...
                  <div class="trigger-main">
                    ...
                    <span class="trigger-val" id="triggerVal"
                      >날짜를 선택해주세요</span
                    >
                  </div>
            ...
            <div class="search-card__row">
              ...
              <div class="traveler-box">
                <div class="traveler-box__head">
                  <span class="traveler-box__badge" id="travelerBadge"
                    >둘이</span
                  >
                </div>
                <div class="traveler-box__body">
                  ...
                  <div class="traveler-stepper">
                    ...
                    <button class="stepper-btn" type="button" data-counter-plus>
                      +
                    </button>
                  </div>
                </div>
                <div class="traveler-presets">
                  <button class="preset-chip" type="button" data-val="1">
                    혼자
                  </button>
                  <button
                    class="preset-chip is-active"
                    type="button"
                    data-val="2"
                  >
                    2명
                  </button>
                  <button class="preset-chip" type="button" data-val="3">
                    3명
                  </button>
                  <button class="preset-chip" type="button" data-val="4">
                    4명+
                  </button>
                </div>
                <input
            ...
            <div class="search-card__row">
              ...
              <div class="price-box">
                ...
                <div class="budget-presets">
                  ...
                  <button
                    class="budget-preset-btn is-active"
                    type="button"
                ...
                <div class="budget-summary">
                  ...
                  <span class="budget-summary__value" id="budgetSummaryVal"
                    >100만 원 이하</span
                  >
                </div>
              </div>
            ...
            <div class="chip-group-wrap">
              ...
              <div class="chip-group">
                <label class="chip"
                  ><input type="checkbox" name="mood" value="힐링" /><span
                    >힐링</span
                  ></label
                >
                <label class="chip"
                  ><input type="checkbox" name="mood" value="도심" /><span
                    >도심</span
                  ></label
                >
                <label class="chip"
                  ><input type="checkbox" name="mood" value="로맨틱" /><span
                    >로맨틱</span
                  ></label
                >
                <label class="chip"
                  ><input type="checkbox" name="mood" value="가족" /><span
                    >가족</span
                  ></label
                >
                <label class="chip"
                  ><input type="checkbox" name="mood" value="모험" /><span
                    >모험</span
                  ></label
                >
              </div>
            ...
            <div class="chip-group-wrap">
              ...
              <div class="chip-group" id="customChipGroup">
                <button type="button" class="chip-add-btn" id="customAddBtn">
                  + 추가
                </button>
              </div>
            </div>
        ...
        <div class="container">
          <div class="image-search-card">
            <div class="section-head section-head--center">
              <h2>이미지로 여행지 찾기</h2>
              <p>
                이미지를 업로드하면 미리보기를 보여주고, 이후 AI 분석 결과를
                연결할 수 있습니다.
              </p>
            </div>
            ...
            <div class="upload-box" id="uploadBox">
              ...
              <button
                type="button"
                class="upload-box__button"
                id="uploadTrigger"
              >
                이미지 업로드
              </button>

              <p class="upload-box__text" id="uploadText">
              ...
              <div class="rank-carousel__track" id="destinationRankGrid">
                ...
                >
                  <div class="destination-card__image">
                    ...
                    />
                    <div class="destination-card__overlay">
                      <strong>오사카</strong><span>일본</span>
                    </div>
                  </div>
                  <div class="destination-card__body">
                    <p>맛과 활기가 살아있는 도시</p>
              ...
              <div class="rank-carousel__track" id="themeRankGrid">
                ...
                >
                  <div class="destination-card__image">
                    ...
                    />
                    <div class="destination-card__overlay">
                      <strong>자연 여행</strong><span>테마</span>
                    </div>
                  </div>
                  <div class="destination-card__body">
                    <p>자연 속 휴식과 힐링 중심 코스</p>
                  </div>
                </article>
                <article
                  class="destination-card"
                ...
                >
                  <div class="destination-card__image">
                    ...
                    />
                    <div class="destination-card__overlay">
                      <strong>맛집 탐방</strong><span>테마</span>
                    </div>
                  </div>
                  <div class="destination-card__body">
                    <p>입이 즐거운 미식 코스 여행</p>
                ...
                >
                  <div class="destination-card__image">
                    ...
                    />
                    <div class="destination-card__overlay">
                      <strong>문화 투어</strong><span>테마</span>
                    </div>
                  </div>
                  <div class="destination-card__body">
                    <p>문화를 직접 느낄 수 있는 여행</p>
                  </div>
                </article>
              </div>
            </div>
    ...
    <div class="float-nav" id="floatNav">
      <div class="float-nav__panel" id="floatNavMenu">
        ...
        >
          ...
          ><span class="float-nav__label">맨 위로</span>
        </button>
        <button
          class="float-nav__item"
      ...
      <button
        class="float-nav__toggle"
        id="floatNavToggle"
        aria-label="메뉴 열기"
      >
        <svg
          class="float-nav__icon-open"
          width="20"
          height="20"
          viewBox="0 0 24 24"
          fill="none"
    ...
    <div
      class="bottom-sheet airport-sheet"
      id="airportSheet"
      role="dialog"
      aria-modal="true"
      aria-labelledby="airportSheetTitle"
    >
      <div class="sheet-handle-wrap"><div class="sheet-handle"></div></div>
      <div class="sheet-head">
        <span class="sheet-head-title" id="airportSheetTitle"
          >출발 공항 선택</span
        >
        <button
          type="button"
          class="sheet-close-btn"
          id="airportSheetClose"
          aria-label="닫기"
        >
          <svg
            width="14"
      ...
      <p class="airport-sheet__desc">
        공항을 누르면 주소와 일본 주요 노선을 확인하고 선택할 수 있어요.
      </p>
      <div class="airport-list" id="airportList"></div>
      <div class="airport-sheet__footer">
        <button
          type="button"
          class="airport-apply-btn"
          id="airportApplyBtn"
          disabled
        >
          선택 완료
    ...
    <div class="bottom-sheet" id="dateSheet">
      ...
      <div class="sheet-footer">
        ...
        <button type="button" class="btn-cal-apply" id="calApplyBtn" disabled>
          적용하기
        </button>
      </div>
    </div>
    ...
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="planSheetTitle"
    >
      ...
      <div class="plan-sheet__head">
        <div>
          ...
          <p class="plan-sheet__sub" id="planSheetSub">
            인기 플랜 중 마음에 드는 것을 선택하세요
          </p>
        </div>
        <button
          class="plan-sheet__close"
    ...
    <script>
      (function loadTopHomeCards() {
          ...
          .then(function (destinations) {
            ...
            destinations.slice(0, 3).forEach(function (item, index) {
              ...
              card.innerHTML =
                ...
                '<img src="' +
                escHomeHtml(
                  getDestinationImage(destination, index, item.imageUrl),
                ) +
                '" alt="' +
                escHomeHtml(destination) +
                '">' +
                ...
                "</div>" +
                "</div>" +
                '<div class="destination-card__body"><p>' +
                escHomeHtml(getDestinationDescription(destination)) +
                "</p></div>";
              ...
              .then(function (tags) {
                ...
                tags.slice(0, 3).forEach(function (item, index) {
                  ...
                  card.innerHTML =
                    '<div class="destination-card__image">' +
                    '<img class="' +
                    getThemeImageClass(tag) +
                    '" src="' +
                    getThemeImage(tag, index) +
                    '" alt="' +
                    escHomeHtml(tag) +
                    '">' +
                    '<span class="destination-card__hint">플랜 목록 열기 <b>→</b></span>' +
                    ...
                    "</div>" +
                    '<div class="destination-card__body"><p>' +
                    escHomeHtml(getThemeDescription(tag)) +
                    "</p></div>";
        ...
        function getDestinationImage(destination, index, planImageUrl) {
          ...
          return fallbackDestinationImages[
        ...
        function getMatchedDestination(destination) {
          ...
          return destinationImageMap.find(function (item) {
            return item.keywords.some(function (keyword) {
              ...
              return (
                normalizedDestination.includes(normalizedKeyword) ||
                normalizedKeyword.includes(normalizedDestination)
              );
            });
          });
        }
      ...
      imageFile.addEventListener("change", function () {
        ...
        reader.onload = function (e) {
          uploadPreview.innerHTML =
            ...
            '<img src="' +
            e.target.result +
            '" alt="업로드 이미지 미리보기" class="upload-preview__image">' +
