...
<div class="result-page">
    ...
    <div class="container-result">
        ...
        <form action="${pageContext.request.contextPath}/save-plan" method="post">
            <input type="hidden" name="title" value="${plans.summary.title}">
        ...
        <div class="info-cards">
            <div class="card">
                ...
                <p class="value">${plans.summary.startDate} ~ ${plans.summary.endDate}</p>
            </div>

            <div class="card">
                <p class="label">👥 여행 인원</p>
                <p class="value">${plans.summary.travelers}명</p>
            </div>

            <div class="card">
                <p class="label">✨ 여행 스타일</p>
                <p class="value">${plans.summary.travelStyle}</p>
            </div>
        </div>
        ...
        <div class="map-section">
            ...
            <div class="map-toolbar">
                <div class="day-filter" id="dayFilter">
                    <c:forEach var="item" items="${plans.itinerary}" varStatus="status">
                        <button
                                type="button"
        ...
        <!-- 일정 리스트 -->
        <div class="schedule">
            <c:forEach var="item" items="${plans.itinerary}">
                <div class="day">
        ...
        <div class="detail-container">
            ...
            <div class="detail-header">
                <h2>상세 일정</h2>
                <div class="total-cost">총 예상 비용: ${plans.summary.totalEstimatedCost} ${plans.summary.currency}</div>
            </div>
        ...
        <div class="recommend-section">
            ...
            <div class="recommend-grid">
                ...
                <div class="recommend-card">
                    <h3>✈️ 항공권 최저가</h3>
                    <c:choose>
                        <c:when test="${empty plans.flights}">
                            <p>항공권 정보를 불러오지 못했습니다.</p>
                        </c:when>
                        <c:otherwise>
                            <c:forEach var="flight" items="${plans.flights}">
                ...
                <div class="recommend-card">
                    <h3>🏨 숙박 추천</h3>
                    <c:forEach var="hotel" items="${plans.hotels}">
                        <div class="recommend-item">
                            <div class="left">
