...
<div class="mp-page">
    <div class="mp-container">
        ...
        <!-- 헤더 -->
        <div class="mp-header">
            <a class="mp-back-link" href="${pageContext.request.contextPath}/mypage">
                ← 마이페이지로 돌아가기
            </a>
        ...
        <!-- 지도 (기능 유지, 클래스 그대로) -->
        <div class="mp-section"> <div class="map-section mp-day-card"> <div class="map-header">
            <span>🗺 여행 동선 지도</span>
            <div class="legend">
            ...
            <div class="mp-recommend-grid">
                <div class="mp-recommend-card">
                    ...
                    <c:forEach var="f" items="${result.flights}">
                        <div class="mp-recommend-item">
                            <div>
                                <div class="mp-recommend-title">${f.airline}</div>
                                <div class="mp-recommend-desc">
                                        ${f.departureAirport} → ${f.arrivalAirport}
                                </div>
                            </div>
                            <div class="mp-recommend-price">${f.price}</div>
                        </div>
                    </c:forEach>
                </div>
                ...
                <div class="mp-recommend-card">
                    ...
                    <c:forEach var="h" items="${result.hotels}">
                        <div class="mp-recommend-item">
                            <div>
                                <div class="mp-recommend-title">${h.name}</div>
                                <div class="mp-recommend-desc">⭐ ${h.rating}</div>
                            </div>
                            <div class="mp-recommend-price">${h.pricePerNight}</div>
                        </div>
                    </c:forEach>
                </div>
            </div>
